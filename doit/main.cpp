...
int main()
{
    ...
    temp_apartment->flats = new Flats();
    struct Flats* temp_flats = temp_apartment->flats;

    temp_flats->flat_id = 1;
    temp_flats->initial_bandwidth = 50;
    temp_flats->is_empty = true;

    struct Flats* second = new Flats();
    second->flat_id = 2;
    second->initial_bandwidth = 75;
    second->is_empty = true;

    temp_flats->next = second;
